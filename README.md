...
Is a utility to load the [US Census's TIGER dataset](https://www.census.gov/geo/maps-data/data/tiger-line.html) into a heavily-indexed, fully relational PostGIS database.

I wrote it after doing this manually for several pet mapping projects. Optimized for lookup speed, simplicity, and referential integrity. Absolutely no consideration is given to disk space.
